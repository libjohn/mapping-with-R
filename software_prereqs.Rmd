...
- **RStudio**: <a href="https://www.rstudio.com/products/rstudio/download/#download" target="_blank">https://www.rstudio.com/products/rstudio/download/#download</a>.  Technically, you can do all the work without RStudio.  However, the code was composed, run, and tested in RStudio so that's all I can verify. YMMV.
...
There's a link to the repository in the upper-right header.
...
All code and data for this website are shareable through the repository under the [CC-BY-NC license](license.html).
