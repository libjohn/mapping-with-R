...
In this workshop we briefly describe and demonstrate how R can enable GIS analysis.  We do not presume that all your GIS analytics can be accomplished via R.  Nor do we presume that they cannot.  Other tools such as QGIS, ArcGIS, and Carto.com are also quite popoular.  However, if you are already an R user, you will find the `sf` package is a very useful and tidy approach to reproducible GIS analytics.  
