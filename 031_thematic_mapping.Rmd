...
Using the `tigris` package, get Census Tiger shapefiles for census geographies.  Tigris will return the shapefile in the `sf`, or simple features, format.  (See also, [more information on Shaepfiles](02_choropleth.html#shapefiles).)
